...
class SpecialitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speciality" do
    assert_difference('Speciality.count') do
      post specialities_url, params: { speciality: { description: @speciality.description, name: @speciality.name, profession_id: @speciality.profession_id } }
    end
  ...
  test "should update speciality" do
    patch speciality_url(@speciality), params: { speciality: { description: @speciality.description, name: @speciality.name, profession_id: @speciality.profession_id } }
